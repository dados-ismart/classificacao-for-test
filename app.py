...
if check_password():
    ...
    if ra_nome is not None:
        ...
        df_historico_filtrado = df_historico_filtrado.query("confirmacao_classificacao_orientadora.notna()").reset_index()   
        df_historico_filtrado.sort_values(by='data_submit', ascending = False)
